...
class TaskDetailViewController: UIViewController {
    ...
    func updateMapView() {
        ...
        //Make suere the task has image location.
        guard let imageLocation = task.imageLocation else { return }
        
        //Get the coordinate from the imaeg locatio. This is the latitude / longitude of the location.
        // https://developer.apple.com/documentation/mapkit/mkmapview
        let coordinate = imageLocation.coordinate
        
        //Get the map view's region based on the coordinate of the imae.
        // the span represents the maps's "zoom level". A smaller value yields a more "zoomed in" map area, while a large value is more "zoomed out".
